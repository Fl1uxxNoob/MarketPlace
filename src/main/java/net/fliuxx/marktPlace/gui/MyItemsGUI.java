...
public class MyItemsGUI {
    ...
    private ItemStack createMyItemDisplay(MarketItem item, ConfigurationSection guiConfig) {
        ...
        if (meta != null) {
            ...
            if (displayConfig != null) {
                ...
                newLore.add("");
                newLore.add("§7Click to remove from marketplace");
    ...
    private void addNavigationButtons(ConfigurationSection guiConfig) {
        ...
        if (hasPreviousPage()) {
            ...
            if (prevConfig != null) {
                ...
                inventory.setItem(prevConfig.getInt("slot", 45), prevButton);
            }
        }
        ...
        if (hasNextPage()) {
            ...
            if (nextConfig != null) {
                ...
                inventory.setItem(nextConfig.getInt("slot", 53), nextButton);
            }
        }
        ...
        if (closeConfig != null) {
            ...
            inventory.setItem(closeConfig.getInt("slot", 48), closeButton);
        }
        ...
        if (pageInfoConfig != null) {
            ...
            inventory.setItem(pageInfoConfig.getInt("slot", 50), pageInfo);
        }
    }
    ...
    /**
     * Get market item at specific slot
     */
    ...
    public void removeItem(MarketItem item) {
        try {
            ...
            plugin.getLogger().warning("Error removing item: " + e.getMessage());
        }
    }
